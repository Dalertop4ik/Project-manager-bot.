...
class DB_Manager:
    ...
    def update_project_image(self, image_name, project_name, user_id):
        sql = "UPDATE projects SET image = ? WHERE project_name = ? AND user_id = ?"
        self.__executemany(sql, [(image_name, project_name, user_id)])
